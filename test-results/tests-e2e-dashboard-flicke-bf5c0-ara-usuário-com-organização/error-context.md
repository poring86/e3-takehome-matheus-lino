...
- Name: tests/e2e/dashboard-flicker-visual.spec.ts >> Dashboard Flicker Visual >> Não há flicker de onboarding para usuário com organização
- Location: tests/e2e/dashboard-flicker-visual.spec.ts:50:7
